...
pretrain_path=/data/sls/scratch/yuangong/cav-mae/egs/vggsound/exp/testmae02-vggsound-cav-mae-balNone-lr1e-4-epoch25-bs120-normTrue-IN-initial.pth-c0.01-p1.0-tpFalse-mr-unstructured-0.75-a5/models/audio_model.25.pth
...
exp_dir=./exp/testmae04-${dataset}-${model}-${lr}-${lrscheduler_start}-${lrscheduler_decay}-${lrscheduler_step}-bs${batch_size}-lda${lr_adapt}-${ftmode}-fz${freeze_base}-h${head_lr}-a5
mkdir -p $exp_dir

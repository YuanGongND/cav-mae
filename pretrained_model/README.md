...
One conclusion of the paper is multi-modal pretraining helps single modality performance. Below we release model pretrained with multi-modal data, but fine-tuned on only audio data. These models works when only audio is input.

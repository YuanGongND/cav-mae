...
save_name_list = ['/data/sls/scratch/yuangong/audiollm/data/audio_strong_cav-mae/' + x['video_id'] for x in data_json]

batch_gen_audio_embedding(model, data, audio_conf=audio_conf, label_csv=label_csv, num_class=527, model_type='finetune', batch_size=600, save_name_list=save_name_list)
...
model = '/data/sls/scratch/yuangong/cav-mae/egs/audioset/exp/testmae01-full-cav-mae-ft-1e-5-2-0.5-1-bs48-ldaFalse-audioonly-fzFalse-h50-a5/models/audio_model_wa.pth'

#data = '/data/sls/scratch/yuangong/audiollm/src/llm/ltu_e/data/as_eval_data_pvid.json'
data = '/data/sls/scratch/yuangong/audiollm/src/llm/ltu_e/data/as_20k_data_pvid.json'
...
save_name_list = ['/data/sls/scratch/yuangong/audiollm/src/llm/ltu_e/data/audio_feat/as_20k/' + x['wav'].split('/')[-1][:-5] for x in data_json]
print(save_name_list[0])

batch_gen_audio_embedding(model, data, audio_conf=audio_conf, label_csv=label_csv, num_class=527, model_type='finetune_audio', batch_size=1000, save_name_list=save_name_list)